...
interface TransactionItem {
  ...
  amount: number;
  transactionType: "deposit" | "withdrawal" | "referral" | "bonus" | "funding" | "capital_access";
...
export default function AdminTransactionsPage() {
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      ...
      case "capital_access":
        return (
          <div className="w-8 h-8 rounded-full bg-[#1e1c2e] border border-[#2d2a45] flex items-center justify-center text-[#8b5cf6]">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
